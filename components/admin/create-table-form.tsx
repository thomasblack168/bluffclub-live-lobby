...
export function CreateTableForm({ locations }: { locations: Loc[] }) {
  return (
    <section className="rounded-xl border border-zinc-800 bg-zinc-900/40 p-4">
      ...
      <form action={createTableAction} className="mt-4 grid gap-3 sm:grid-cols-2">
        ...
        <div className="sm:col-span-2">
          <button
            type="submit"
            className="rounded-lg bg-emerald-600 px-4 py-2 text-sm font-bold uppercase tracking-wide text-white hover:bg-emerald-500"
          >
            Create table
          </button>
        </div>
